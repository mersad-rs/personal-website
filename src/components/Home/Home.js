...
const Home = () => {
    return(
        <div className="homeContain bg-black text-white">
            <div className="homeHead bg-dark p-5 mx-5 rounded-5 border border-danger">
                <h2>Hello and thank you for visiting my personal website! Feel free to browse around, and don’t hesitate to reach out if you have any questions or just want to say hi. Your thoughts and feedback are always welcome!</h2>
            </div>
            <div className="w-md-50 container my-5 text-start p-5 rounded-5 bg-dark border border-danger">
